...
// testa só a BD e o EmployeeRepository e cria a BD em memória embedded H2 e não usa a BD de produção e deita fora no fim
    // Pode se concluir o acesso a BD e se a query em EmployeeRepository está correta
@DataJpaTest
